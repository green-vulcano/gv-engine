 ...
 *
 */
public class JMSMapMessageDataProvider extends AbstractJMSMessageDataProvider
{

    /**
     * This implementation of data provider needs to have JMS {#link Session}
     * object set as property. When setting session, a new {#link MapMessage}
     * is created.
     *
    ...
    public void setContext(Object object) throws Exception
    {
        ...
        currentMessage = ((Session) object).createMapMessage();
