...
public class GaiaConfigurator {
    ...
    public static void main(String[] args) throws java.io.IOException {
       ...
       setConfigigurationProperty("org.ops4j.pax.url.mvn.cfg", "org.ops4j.pax.url.mvn.repositories", "http://mvn.greenvulcano.com/nexus/content/groups/public@id=gv");
    ...
    private static void setConfigigurationProperty(String configFileName, String key, String ... values) throws java.io.IOException  {

       var configPath = java.nio.file.Paths.get(System.getenv("KARAF_HOME"), "etc", configFileName);
