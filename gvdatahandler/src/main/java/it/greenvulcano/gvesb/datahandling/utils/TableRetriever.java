...
import it.greenvulcano.gvesb.utils.ResultSetUtils;
 ...
 *
 */
public class TableRetriever extends AbstractRetriever
{
    private static final Logger            logger             = org.slf4j.LoggerFactory.getLogger(TableRetriever.class);
        ...
        try {
            ...
            if (stmt != null) {
                ...
                try {
                    ...
                    result = ResultSetUtils.getResultSetAsXMLString(rs);
                }
                finally {
                    if (rs != null) {
                        try {
