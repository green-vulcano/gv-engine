 ...
 *
 */
public class ProxyCallOperation implements CallOperation
{
    private static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(ProxyCallOperation.class);
