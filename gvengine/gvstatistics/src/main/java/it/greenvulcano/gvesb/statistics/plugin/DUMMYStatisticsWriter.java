...
public class DUMMYStatisticsWriter implements IStatisticsWriter {
    private static Logger   logger    = LoggerFactory.getLogger(DUMMYStatisticsWriter.class);
    ...
    public void init(Node node) throws GVStatisticsException {
        logger.debug("DUMMYStatisticsWriter init");
    }
    ...
    public boolean writeStatisticsData(StatisticsData statisticsData) throws GVStatisticsException {
        ...
        logger.debug(statisticsData.toString());
    ...
    public void destroy()
    {
        logger.debug("DESTROY DUMMY StatisticsData");
    }
}
