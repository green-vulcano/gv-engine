...
/**
 * <code>CallOperationWrapper</code> is a wrapper for <code>CallOperation</code>
 * instances that provides standard functionalities.
 * <p>
 ...
 *
 */
public class CallOperationWrapper implements CallOperation
{
    private static final org.slf4j.Logger logger       = org.slf4j.LoggerFactory.getLogger(CallOperationWrapper.class);
     ...
     */
    public CallOperationWrapper(CallOperation operation, String description)
    {
     ...
     */
    public CallOperation getWrappedOperation()
    {
        return operation;
    }
