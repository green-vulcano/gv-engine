 ...
 * 
 * You should have received a copy of the GNU Lesser General Public License
 * along with this file. If not, see <a href="http://www.gnu.org/licenses">GNU Licenses</a>.
 */
 ...
 * 
 * The ThreadUtilities class provides a collection of static methods for
 * listing and finding Thread, ThreadGroup, and ThreadInfo objects.
 * <p>
 * Please see the accompanying article: <a href="http://nadeausoftware.com/articles/2008/04/java_tip_how_list_and_find_threads_and_thread_groups">Java tip: How to list and find threads and thread groups</a>
 */
public class ThreadUtils
{
    ...
    public static ThreadInfo[] getAllThreadInfos() {
        ...
        if (nNotNulls == infos.length) return infos; // Original had no nulls
