...
/**
 * Exception for the XAHelper.
 *
 * @version 3.0.0 Feb 17, 2010
 * @author GreenVulcano Developer Team
 */
public class XAHelperException extends GVInternalException
{
    private static final long serialVersionUID = 210L;

    /**
     * Creates a new XAHelperException with error code identified by
     * <code>errorId</code> and no cause.
     *
     * @param idMessage
     *        message associated to an error in the error catalog
     */
    public XAHelperException(String idMessage)
    {
        super(idMessage);
    }
     ...
     *        message.
     */
    public XAHelperException(String idMessage, String[][] params)
    {
     ...
     */
    public XAHelperException(String idMessage, Throwable cause)
    {
        super(idMessage, cause);
    }

    /**
     * Creates a new XAHelperException with a cause.
     *
     * @param idMessage
     *        message associated to the exception
     * @param params
     ...
     *        Throwable that caused this exception to get thrown
     */
    public XAHelperException(String idMessage, String[][] params, Throwable cause)
    {
