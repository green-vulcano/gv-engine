 ...
 * to read the value within the binary field (or within the string) as a signed
 * integer.
 *
 *
 ...
 *
 */
public class SignedIntConversion extends NumConversion
{
    private static Logger logger = org.slf4j.LoggerFactory.getLogger(SignedIntConversion.class);

    /**
     * This method implements the encoding algorithm. It reads the input byte
     * array (containing a <tt>signed integer</tt> variable) considering the
     * first byte as the most meaningful one and converts it to a string
     ...
     * representing a <tt>signed integer</tt> variable into an 4-bytes array
